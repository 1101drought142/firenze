...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'firenze.settings')  # Замените myproject на имя вашего проекта

# Инициализируйте Django
django.setup()


file = open("media/imported_data/2025-01-22/catalog_15-54-28.json", "r")
text = file.read()
